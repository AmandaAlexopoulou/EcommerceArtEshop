...
/*provider_response (σαν TEXT)->αποθηκεύει την απάντηση ή το αποτέλεσμα από τον πάροχο τιμολόγησης ή πληρωμών
 όταν στέλνεται το τιμολόγιο π.χ.αν χρησιμοποιώ πάροχο για ηλεκτρονική τιμολόγηση, αυτό το πεδίο μπορεί να περιέχει JSON ή απλό μήνυμα
 ->για logging και εντοπισμό προβλημάτων όταν στέλνω τιμολόγια σε τρίτα συστήματα. Ενώ το provider_invoice_id (σαν TEXT)
Αποθηκεύει το μοναδικό αναγνωριστικό τιμολογίου που παρέχει ο πάροχος (π.χ.κάποιο API ηλεκτρονικής τιμολόγησης) και επιτρέπει 
συσχέτιση του τοπικού τιμολογίου (invoice_number) με το τιμολόγιο στον πάροχο, ώστε να μπορώ να κάνω αναζητήσεις ή επαληθεύσεις.->
αυτά τα πεδία δεν είναι απαραίτητα για την τοπική λειτουργία του eshop, αλλά είναι χρήσιμα όταν στέλνεις τα τιμολόγια σε εξωτερικά συστήματα
 ή κρατικές πλατφόρμες ηλεκτρονικής τιμολόγησης.*/
